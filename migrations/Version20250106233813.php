 ...
 */
final class Version20250106233813 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE poste_entity ADD CONSTRAINT FK_DEFE5B6DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
