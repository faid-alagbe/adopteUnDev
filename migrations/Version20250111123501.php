 ...
 */
final class Version20250111123501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company_crters (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, langages VARCHAR(255) DEFAULT NULL, salaire INT DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, experience_year INT DEFAULT NULL, UNIQUE INDEX UNIQ_FF6B0E7F979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE company_crters ADD CONSTRAINT FK_FF6B0E7F979B1AD6 FOREIGN KEY (company_id) REFERENCES company (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE company_crters DROP FOREIGN KEY FK_FF6B0E7F979B1AD6');
        ...
        $this->addSql('DROP TABLE company_crters');
