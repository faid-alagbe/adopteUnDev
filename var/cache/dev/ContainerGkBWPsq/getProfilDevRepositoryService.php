 ...
 */
class getProfilDevRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProfilDevRepository' shared autowired service.
     *
     * @return \App\Repository\ProfilDevRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProfilDevRepository.php';

        return $container->privates['App\\Repository\\ProfilDevRepository'] = new \App\Repository\ProfilDevRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
