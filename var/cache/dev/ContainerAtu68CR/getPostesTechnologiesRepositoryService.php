 ...
 */
class getPostesTechnologiesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PostesTechnologiesRepository' shared autowired service.
     *
     * @return \App\Repository\PostesTechnologiesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PostesTechnologiesRepository.php';

        return $container->privates['App\\Repository\\PostesTechnologiesRepository'] = new \App\Repository\PostesTechnologiesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
