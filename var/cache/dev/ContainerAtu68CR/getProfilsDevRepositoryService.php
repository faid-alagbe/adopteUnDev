 ...
 */
class getProfilsDevRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProfilsDevRepository' shared autowired service.
     *
     * @return \App\Repository\ProfilsDevRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProfilsDevRepository.php';

        return $container->privates['App\\Repository\\ProfilsDevRepository'] = new \App\Repository\ProfilsDevRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
