 ...
 */
class getProfilsDevLangagesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProfilsDevLangagesRepository' shared autowired service.
     *
     * @return \App\Repository\ProfilsDevLangagesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProfilsDevLangagesRepository.php';

        return $container->privates['App\\Repository\\ProfilsDevLangagesRepository'] = new \App\Repository\ProfilsDevLangagesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
