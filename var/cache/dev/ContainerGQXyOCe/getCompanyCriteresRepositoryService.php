 ...
 */
class getCompanyCriteresRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompanyCriteresRepository' shared autowired service.
     *
     * @return \App\Repository\CompanyCriteresRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompanyCriteresRepository.php';

        return $container->privates['App\\Repository\\CompanyCriteresRepository'] = new \App\Repository\CompanyCriteresRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
