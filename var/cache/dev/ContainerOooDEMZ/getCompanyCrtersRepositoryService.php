 ...
 */
class getCompanyCrtersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompanyCrtersRepository' shared autowired service.
     *
     * @return \App\Repository\CompanyCrtersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompanyCrtersRepository.php';

        return $container->privates['App\\Repository\\CompanyCrtersRepository'] = new \App\Repository\CompanyCrtersRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
