...
\t\t\t\t\t<div class=\"row\">
            ";
                ...
                $context['_seq'] = CoreExtension::ensureTraversable((isset($context["devs"]) || array_key_exists("devs", $context) ? $context["devs"] : (function () {
                        throw new RuntimeError('Variable "devs" does not exist.', 330, $this->source);
                })()));
...
\t\t\t\t\t\t\t\t\t\t\t\t\t<h5>";
                        // line 342
                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["dev"], "nom", [], "any", false, false, false, 342), "html", null, true);
                        yield "</h5>
\t\t\t\t\t\t\t\t\t\t\t\t</a>
                                                <p class=\"text-warning fst-italic fw-light\">
                                                    &quot; ";
                        // line 345
                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["dev"], "biographie", [], "any", false, false, false, 345), "html", null, true);
                        yield " &quot;
                                                </p>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                        // line 351
                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["dev"], "localisation", [], "any", false, false, false, 351), "html", null, true);
                        yield "
\t\t\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"list-inline-item\">
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
                        // line 355
                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["dev"], "salaireMin", [], "any", false, false, false, 355), "html", null, true);
                        yield "
\t\t\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t\t</ul>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                        // line 359
                        $context['_parent'] = $context;
                        $context['_seq'] = CoreExtension::ensureTraversable(Twig\Extension\CoreExtension::slice($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, $context["dev"], "langages", [], "any", false, false, false, 359), 0, 6));
...
";
        ...
        {
                return array(600 => 374,  583 => 362,  574 => 360,  570 => 359,  563 => 355,  556 => 351,  547 => 345,  541 => 342,  533 => 337,  525 => 331,  521 => 330,  483 => 295,  476 => 291,  468 => 287,  462 => 285,  456 => 283,  454 => 282,  442 => 272,  436 => 270,  430 => 268,  427 => 267,  421 => 265,  415 => 263,  413 => 262,  408 => 260,  394 => 249,  388 => 246,  379 => 240,  373 => 237,  327 => 193,  319 => 188,  312 => 184,  305 => 180,  300 => 179,  294 => 177,  292 => 176,  284 => 170,  277 => 167,  270 => 164,  268 => 163,  263 => 161,  219 => 120,  206 => 110,  193 => 100,  121 => 31,  115 => 28,  106 => 22,  100 => 19,  86 => 7,  76 => 6,  58 => 3,  41 => 1,);
        }
...
{% block title %}Liste des developpeurs
{% endblock %}
