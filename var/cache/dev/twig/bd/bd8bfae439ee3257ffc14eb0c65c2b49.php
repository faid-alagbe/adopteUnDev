...
class __TwigTemplate_e55eb0d90e5386b99f32d4f2da7e2eee extends Template
{
    ...
    <div class=\"row\">
        ...
        yield "\" class=\"btn btn-outline-warning material-shadow-none my-3\" >back to list</a>
                                ...
                                <div class=\"card-body\">
                                    ...
                                    ";
        // line 907
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 907, $this->source); })()), 'form_start');
        yield "
                                        ";
        // line 908
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 908, $this->source); })()), 'widget');
        yield "
                                        <div class=\"text-end\">
                                            <button class=\"btn btn-primary material-shadow-none my-3\">";
        // line 910
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("button_label", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 910, $this->source); })()), "Modifier")) : ("Modifier")), "html", null, true);
        yield "</button>
                                        </div>
                                    ";
        // line 912
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 912, $this->source); })()), 'form_end');
        yield "
                                        <!--end row-->
                                    </div>
...
";
    ...
    {
        return array (  1179 => 948,  1173 => 945,  1167 => 942,  1163 => 941,  1159 => 940,  1155 => 939,  1151 => 938,  1147 => 937,  1119 => 912,  1114 => 910,  1109 => 908,  1105 => 907,  1096 => 901,  1059 => 867,  1053 => 864,  1044 => 858,  1038 => 855,  945 => 765,  894 => 717,  865 => 691,  836 => 665,  808 => 640,  768 => 603,  710 => 548,  574 => 415,  545 => 389,  517 => 364,  490 => 340,  462 => 315,  418 => 274,  409 => 268,  400 => 262,  388 => 253,  379 => 247,  370 => 241,  336 => 210,  327 => 204,  318 => 198,  309 => 192,  300 => 186,  291 => 180,  282 => 174,  273 => 168,  263 => 161,  219 => 120,  206 => 110,  193 => 100,  120 => 30,  114 => 27,  105 => 21,  99 => 18,  85 => 6,  75 => 5,  58 => 3,  41 => 1,);
    }
                            ...
                            <div class=\"card\">
                                ...
                                <div class=\"card-body\">
                                    ...
                                    {{ form_start(form) }}
                                        {{ form_widget(form) }}
                                        <div class=\"text-end\">
                                            <button class=\"btn btn-primary material-shadow-none my-3\">{{ button_label|default('Modifier') }}</button>
                                        </div>
                                    {{ form_end(form) }}
                                        <!--end row-->
                                    </div>
...
{# 
    {{ include('postes/_form.html.twig', {'button_label': 'Update'}) }}

    <a href=\"{{ path('app_postes_index') }}\">back to list</a>

    {{ include('postes/_delete_form.html.twig') }} #}
{% endblock %}
", "postes/edit.html.twig", "C:\\Users\\HP Elitebook\\Documents\\Cours ISTIC\\PW\\adopteUnDev1\\templates\\postes\\edit.html.twig");
    }
}
