...
class __TwigTemplate_d2739d32707d846ce71a386135c9df71 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "company/show.html.twig", 3);
...
\t\t\t\t\t\t\t\t\t\t<span class=\"d-none d-xl-inline-block ms-1 fw-medium user-name-text\">";
        // line 167
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["profils_company"]) || array_key_exists("profils_company", $context) ? $context["profils_company"] : (function () { throw new RuntimeError('Variable "profils_company" does not exist.', 167, $this->source); })()), "nom", [], "any", false, false, false, 167), "html", null, true);
        yield "</span>
...
\t\t\t\t\t\t\t\t<h6 class=\"dropdown-header\">Bienvenue ";
        // line 176
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["profils_company"]) || array_key_exists("profils_company", $context) ? $context["profils_company"] : (function () { throw new RuntimeError('Variable "profils_company" does not exist.', 176, $this->source); })()), "nom", [], "any", false, false, false, 176), "html", null, true);
        yield "</h6>
...
\t\t\t\t\t\t\t\t<a class=\"dropdown-item\" href=\"";
        // line 185
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("app_dev_critere");
        yield "\">
\t\t\t\t\t\t\t\t\t<i class=\"mdi mdi-magnify text-muted fs-16 align-middle me-1\"></i>
\t\t\t\t\t\t\t\t\t<span class=\"align-middle\">Développeurs suggérés</span>
\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t<a class=\"dropdown-item\" href=\"";
        // line 189
...
\t\t\t\t\t<h3 class=\"text-white mb-1\">";
        // line 219
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["profils_company"]) || array_key_exists("profils_company", $context) ? $context["profils_company"] : (function () { throw new RuntimeError('Variable "profils_company" does not exist.', 219, $this->source); })()), "nom", [], "any", false, false, false, 219), "html", null, true);
        yield "</h3>
...
\t\t\t\t\t\t\t";
        // line 224
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["profils_company"]) || array_key_exists("profils_company", $context) ? $context["profils_company"] : (function () { throw new RuntimeError('Variable "profils_company" does not exist.', 224, $this->source); })()), "location", [], "any", false, false, false, 224), "html", null, true);
        yield "</div>
...
\t\t\t\t\t\t\t<h4 class=\"text-white mb-1\">";
        // line 234
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["nombreposte"]) || array_key_exists("nombreposte", $context) ? $context["nombreposte"] : (function () { throw new RuntimeError('Variable "nombreposte" does not exist.', 234, $this->source); })()), "html", null, true);
        yield "</h4>
...
\t\t\t\t\t\t\t<a class=\"nav-link nav-link\" href=\"";
        ...
        yield "\" role=\"tab\">
\t\t\t\t\t\t\t\t<i class=\"ri-heart-line d-inline-block d-md-none\"></i>
...
\t\t\t\t\t\t<a href=\"";
        // line 263
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_profils_company_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["profils_company"]) || array_key_exists("profils_company", $context) ? $context["profils_company"] : (function () { throw new RuntimeError('Variable "profils_company" does not exist.', 263, $this->source); })()), "id", [], "any", false, false, false, 263)]), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 290
        if ((array_key_exists("profils_company", $context) &&  !(null === (isset($context["profils_company"]) || array_key_exists("profils_company", $context) ? $context["profils_company"] : (function () { throw new RuntimeError('Variable "profils_company" does not exist.', 290, $this->source); })())))) {
            // line 291
            yield "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-muted\">";
            // line 294
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["profils_company"]) || array_key_exists("profils_company", $context) ? $context["profils_company"] : (function () { throw new RuntimeError('Variable "profils_company" does not exist.', 294, $this->source); })()), "nom", [], "any", false, false, false, 294), "html", null, true);
            yield "</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-muted\">";
            // line 299
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["profils_company"]) || array_key_exists("profils_company", $context) ? $context["profils_company"] : (function () { throw new RuntimeError('Variable "profils_company" does not exist.', 299, $this->source); })()), "location", [], "any", false, false, false, 299), "html", null, true);
            yield "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>
\t\t\t\t\t\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t\t\t";
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["developpeurs"]) || array_key_exists("developpeurs", $context) ? $context["developpeurs"] : (function () { throw new RuntimeError('Variable "developpeurs" does not exist.', 340, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["developpeur"]) {
            // line 341
            yield "\t\t\t\t\t\t\t\t\t\t\t<div class=\"d-flex align-items-center py-3\">
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<h5 class=\"fs-14 mb-1\"> ";
            // line 347
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["developpeur"], "nom", [], "any", false, false, false, 347), "html", null, true);
            yield " ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["developpeur"], "prenom", [], "any", false, false, false, 347), "html", null, true);
            yield " </h5>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"fs-13 text-muted mb-0\">";
            // line 348
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["developpeur"], "biographie", [], "any", false, false, false, 348), "html", null, true);
            yield " </p>
\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"flex-shrink-0 ms-2\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-sm btn-outline-danger material-shadow-none btn-favorite\" data-dev-id=\"";
            // line 352
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["developpeur"], "id", [], "any", false, false, false, 352), "html", null, true);
            yield "\" title=\"Ajouter aux favoris\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"las la-heart align-middle favorite-icon\"></i>
\t\t\t\t\t\t\t\t\t\t\t\t\t</button>
\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t<a href=\"";
        ...
        yield "\" class=\"btn btn-sm btn-outline-success material-shadow-none p-3\">
\t\t\t\t\t\t\t\t\t<i class=\"ri-add-line align-middle\"></i> Créer des critères
\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t<!-- end card body -->
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t\t\t\t\t\t\t";
        // line 379
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["profils_company"]) || array_key_exists("profils_company", $context) ? $context["profils_company"] : (function () { throw new RuntimeError('Variable "profils_company" does not exist.', 379, $this->source); })()), "presentation", [], "any", false, false, false, 379), "html", null, true);
        yield "
\t\t\t\t\t\t\t\t\t\t</p>
...
\t\t\t\t\t\t\t\t\t\t\t";
        // line 408
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(Twig\Extension\CoreExtension::slice($this->env->getCharset(), (isset($context["postes"]) || array_key_exists("postes", $context) ? $context["postes"] : (function () { throw new RuntimeError('Variable "postes" does not exist.', 408, $this->source); })()), 0, 3));
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"text-body\">";
            // line 415
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["poste"], "titre", [], "any", false, false, false, 415), "html", null, true);
            yield "</a>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</hlocation>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"fw-semibold text-body\">";
            // line 419
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["poste"], "salaire", [], "any", false, false, false, 419), "html", null, true);
            yield "</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"ms-5\">
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 424
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, $context["poste"], "langages", [], "any", false, false, false, 424));
            foreach ($context['_seq'] as $context["_key"] => $context["langage"]) {
                // line 425
                yield "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"btn btn-primary d-inline me-3 mb-2\">";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["langage"], "nom", [], "any", false, false, false, 425), "html", null, true);
                yield "</li>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            }
            $_parent = $context['_parent'];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tDescription :</hlocation>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 438
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["poste"], "description", [], "any", false, false, false, 438), "html", null, true);
            yield "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.btn-favorite').forEach(button => {
        const devId = button.dataset.devId;
        const icon = button.querySelector('.favorite-icon');
        
        // Vérifier si déjà en favoris
        fetch(`/favoris/verifier/\${devId}`)
        ...
        button.addEventListener('click', function() {
            ...
            const url = isFavorite ? `/favoris/retirer/\${devId}` : `/favoris/ajouter/\${devId}`;
...
";
    ...
    {
        return array (  1774 => 1573,  1764 => 1572,  635 => 450,  617 => 438,  604 => 427,  595 => 425,  591 => 424,  583 => 419,  576 => 415,  568 => 409,  564 => 408,  532 => 379,  512 => 362,  506 => 358,  494 => 352,  487 => 348,  481 => 347,  473 => 341,  469 => 340,  458 => 332,  429 => 305,  425 => 303,  418 => 299,  410 => 294,  405 => 291,  403 => 290,  373 => 263,  363 => 256,  338 => 234,  325 => 224,  317 => 219,  284 => 189,  277 => 185,  270 => 181,  263 => 177,  259 => 176,  247 => 167,  87 => 9,  77 => 8,  59 => 5,  42 => 3,);
    }
...
\t\t\t\t\t\t\t\t\t<span class=\"align-middle\">Faire un poste</span>
\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t<a class=\"dropdown-item\" href=\"{{ url('app_dev_critere')}}\">
\t\t\t\t\t\t\t\t\t<i class=\"mdi mdi-magnify text-muted fs-16 align-middle me-1\"></i>
\t\t\t\t\t\t\t\t\t<span class=\"align-middle\">Développeurs suggérés</span>
\t\t\t\t\t\t\t\t</a>
...
\t\t\t\t\t<div class=\"col-lg-6 col-4\">
\t\t\t\t\t\t<div class=\"p-2\">
\t\t\t\t\t\t\t<h4 class=\"text-white mb-1\">{{ nombreposte }}</h4>
\t\t\t\t\t\t\t<p class=\"fs-14 mb-0\">Postes</p>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
\t\t\t\t\t<ul class=\"nav nav-pills animation-nav profile-nav gap-2 gap-lg-3 flex-grow-1\" role=\"tablist\">
\t\t\t\t\t\t<li class=\"nav-item\">
\t\t\t\t\t\t\t<a class=\"nav-link nav-link\" href=\"{{ path('app_favoris_index') }}\" role=\"tab\">
\t\t\t\t\t\t\t\t<i class=\"ri-heart-line d-inline-block d-md-none\"></i>
\t\t\t\t\t\t\t\t<span class=\"d-none d-md-inline-block\">Mes Favoris</span>
\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t</li>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t<ul class=\"dropdown-menu dropdown-menu-end\" aria-labelledby=\"dropdownMenuLink2\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a class=\"dropdown-item\" href=\"{{ url('app_profils_dev_index') }}\">Afficher tout</a>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</li>
...
\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"flex-grow-1\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<h5 class=\"fs-14 mb-1\"> {{ developpeur.nom}} {{ developpeur.prenom}} </h5>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"fs-13 text-muted mb-0\">{{ developpeur.biographie}} </p>
\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"flex-shrink-0 ms-2\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-sm btn-outline-danger material-shadow-none btn-favorite\" data-dev-id=\"{{ developpeur.id }}\" title=\"Ajouter aux favoris\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"las la-heart align-middle favorite-icon\"></i>
\t\t\t\t\t\t\t\t\t\t\t\t\t</button>
\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t<a href=\"{{ path('app_company_crters_new') }}\" class=\"btn btn-sm btn-outline-success material-shadow-none p-3\">
\t\t\t\t\t\t\t\t\t<i class=\"ri-add-line align-middle\"></i> Créer des critères
\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t<!-- end card body -->
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"flex-grow-1 text-muted overflow-hidden\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<hlocation class=\"fs-14 text-truncate mb-1\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"text-body\">{{poste.titre}}</a>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</hlocation>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"text-muted text-truncate mb-0\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tSalaire :
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"fw-semibold text-body\">{{ poste.salaire }}</span>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</p>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"ms-5\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<ul class=\"list-unstyled d-flex flex-wrap\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t{% for langage in poste.langages %}
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"btn btn-primary d-inline me-3 mb-2\">{{ langage.nom }}</li>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t{% endfor %}
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t</div>
\t</div>
</div></footer></div><!-- end main content--></div><!-- END layout-wrapper -->{% endblock %}
{% block javascripts %}
{{ parent() }}
<script>
document.addEventListener('DOMContentLoaded', function() {
...
{% endblock %}
", "company/show.html.twig", "C:\\Users\\EMA\\Documents\\php istic\\projet\\adopteUnDev\\templates\\company\\show.html.twig");
    }
}
