...
return [
    ...
    [ // $staticRoutes
        ...
        '/language' => [[['_route' => 'app_language_index', '_controller' => 'App\\Controller\\LanguageController::index'], null, ['GET' => 0], null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        110 => [[['_route' => 'app_language_show', '_controller' => 'App\\Controller\\LanguageController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        123 => [[['_route' => 'app_language_edit', '_controller' => 'App\\Controller\\LanguageController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        131 => [[['_route' => 'app_language_delete', '_controller' => 'App\\Controller\\LanguageController::delete'], ['id'], ['POST' => 0], null, false, true, null]],
        158 => [[['_route' => 'app_poste_show', '_controller' => 'App\\Controller\\PosteController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        171 => [[['_route' => 'app_poste_edit', '_controller' => 'App\\Controller\\PosteController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        179 => [
