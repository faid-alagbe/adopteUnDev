 ...
 */
class getCompanyCritersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompanyCritersRepository' shared autowired service.
     *
     * @return \App\Repository\CompanyCritersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompanyCritersRepository.php';

        return $container->privates['App\\Repository\\CompanyCritersRepository'] = new \App\Repository\CompanyCritersRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
