 ...
 */
class getEvaluationsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EvaluationsRepository' shared autowired service.
     *
     * @return \App\Repository\EvaluationsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EvaluationsRepository.php';

        return $container->privates['App\\Repository\\EvaluationsRepository'] = new \App\Repository\EvaluationsRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
