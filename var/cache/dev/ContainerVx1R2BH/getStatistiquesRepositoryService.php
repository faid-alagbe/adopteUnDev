 ...
 */
class getStatistiquesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StatistiquesRepository' shared autowired service.
     *
     * @return \App\Repository\StatistiquesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StatistiquesRepository.php';

        return $container->privates['App\\Repository\\StatistiquesRepository'] = new \App\Repository\StatistiquesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
