 ...
 */
class getLangagesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LangagesRepository' shared autowired service.
     *
     * @return \App\Repository\LangagesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LangagesRepository.php';

        return $container->privates['App\\Repository\\LangagesRepository'] = new \App\Repository\LangagesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
